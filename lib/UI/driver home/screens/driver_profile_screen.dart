...
class DriverProfileScreen extends StatelessWidget {
  ...
  static const String payoutCurrency = 'egp';
  static const int minThresholdCents = 5000;
  ...
  void _openPayoutSheet(BuildContext context, DriverModel driver) {
    ...
    final amountCtrl = TextEditingController(
      text: driver.balance.toStringAsFixed(2),
    );
        ...
        return Padding(
          ...
          child: BlocBuilder<DriverCubit, DriverState>(
            builder: (context, state) {
              ...
              const minThreshold = (minThresholdCents / 100.0);
              return Column(
                  ...
                  TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      border: OutlineInputBorder(
                          borderSide: BorderSide(color: KColor.primary),
                          borderRadius: BorderRadius.circular(12.r)),
                    ),
                  ),
                  SizedBox(height: 12.h),
                      ...
                      Expanded(
                        ...
                        onPressed: loading
                            ...
                            : () async {
                                ...
                                await context.read<DriverCubit>().requestPayout(
